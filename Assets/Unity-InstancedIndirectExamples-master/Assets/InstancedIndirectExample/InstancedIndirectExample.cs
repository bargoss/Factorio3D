...
{ 
    ...
    public Material instanceMaterial2;
	...
	{ 
      ...
      //  instanceMaterial.SetBuffer("positionBuffer", positionBuffer);
        ...
        Graphics.DrawMeshInstanced(instanceMesh, 0, instanceMaterial2, transforms);
    }
	...
	{ 
        ...
        for (int i=0; i < instanceCount; i++)
		{
            ...
            transforms[i] = Matrix4x4.TRS(position, Quaternion.identity, Vector3.one);
        }
